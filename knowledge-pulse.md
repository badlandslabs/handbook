...
| I-116 | The A2A Trust Gap: When Agents Talk to Strangers Without Proving Who They Are | a2a-trust-gap, agent-impersonation, card-tampering, replay-attack, delegation-token, mTLS-PKI, signed-agent-cards, AP2-mandates, A2A-security, cross-org-delegation, capability-advertisement, nonce-TTL, jws-agent-card, replay-detection, jti, delegation-chain, trust-establishment | 10 | 10 | 9 | 10 | 9 | **9.75** | WRITTEN — S-918 | 2026-07-10 | 2026-07-10 |
...
|| Verification-Correction Separation | Self-correction loops are unreliable when the verifier lives inside the same model context. LLMs correct third-party errors at higher rates than self-errors due to addressability loss. The fix: structurally separate the generator agent from the verification agent, present claims as de-anchored evidence, and use deterministic checkers for unambiguous error classes. | I-114 | arxiv:2606.05976 (Chen et al., 2026); ReliabilityBench (arxiv:2601.06112) |
...
|| 2026-07-10 | I-117 | WRITTEN — S-919 | Agent Production Readiness Gate — Candidate ideas ranked: (A) Contextual Red-Teaming (8.90) — DUPLICATE: S-289 covers structured red-teaming methodology; the "contextual profiling first" sub-angle is too narrow for a standalone entry. (B) Agent Self-Metering (6.85) — partially covered by S-362 (Budget-Aware Agents), S-389 (Cost Numbers). (C) Multi-Agent Failure Taxonomies (7.50) — partially covered by S-391, S-396. (D) Semantic Caching (6.75) — covered by S-08 (Prompt Caching) prefix/semantic entries. Winner: Agent Production Readiness Gate (8.95 composite). Gap: S-355 defines autonomy levels but doesn't answer "is THIS agent ready at THAT level right now?" The readiness gate fills the missing deployment checkpoint. Not covered by S-281 (eval layer), S-901 (golden set trap), or S-368 (span tracing). Core pattern: readiness is a vector (level × time × eval-set), not a binary. |
...
- Created: 2026-07-02
- Last Updated: 2026-07-10 (run: +I-086 / S-894 — The Tool Schema Contract Stack)
- Total ideas discovered: 108
