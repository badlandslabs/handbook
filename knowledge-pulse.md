...
## Recent Decisions
| 2026-07-24 | I-3012 | WRITTEN — S-1590 | Composite 9.80. Fresh research: EU AI Act full enforcement Aug 2, 2026; arXiv:2603.16586 (Runtime Governance for AI Agents: Policies on Paths — formalizes reasoning traces as governance objects); arXiv:2509.23864 (AgentGuard — MDP-based dynamic probabilistic assurance over reasoning traces); Zylos Research (May 2026 — 82% of enterprises lack agent audit trails); Oracle Agent Reasoning (CoT/ReAct/self-reflection open-source layer for Ollama). Fresh angle: no existing entry covers reasoning trace as a first-class compliance artifact for EU AI Act / ISO 42001 explainability. |
