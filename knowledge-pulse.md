...
OWASP-ASI → I-3026
## Recent Decisions
|| 2026-07-25 | I-3024 | WRITTEN — S-1647 | Composite 8.65. Fresh research from AgentMarketCap (85% of enterprise AI budget is inference, agentic workflows 10-20x more token volume than chatbots, $1.60/task for complex support agents), Zylos Research (Feb 2026 token economics), BCG (2026 FinOps), NextPageIT FinOps guide. I-3025 (Context Rot, 7.55) and I-3026 (Agentic Sandbox, 6.95) queued as CANDIDATE. Deduplication: S-02 covers context budgets but not token-level cost accounting; S-06 covers model routing but not cost-aware routing with budget share enforcement; S-1001 covers trajectory-level eval but not cost-per-run as first-class metric; S-1003 covers failure recovery but not cost runaway as a recovery trigger. Novel angle: token cost as a first-class SLO with 3-tier enforcement and complexity-based model routing. |
...
| I-3024 | The Token Cost Compounding Stack — When Your Agent's First Step Costs 10× More Than You Planned | cost-compounding, token-economics, finops, agentic-SLO, cost-circuit-breaker, inference-spend, token-budget, model-routing, output-ratio, cost-observability, bca-gamma-2026, zylos-2026 | 9 | 8 | 9 | 10 | 7 | **8.65** | WRITTEN — S-1647 | 2026-07-25 | 2026-07-25 |
| I-3025 | The Context Rot Stack — When Your Agent Gets Dumber Mid-Workflow | context-rot, context-drift, forgetting, performance-degradation, context-management, context-engineering, agent-amnesia, forrester-65pct | 7 | 8 | 8 | 8 | 7 | **7.55** | CANDIDATE | 2026-07-25 | 2026-07-25 |
| I-3026 | The Agentic Sandbox Stack — When Your Agent's Tool Call Becomes Your Security Incident | sandboxing, microvm, gvisor, firecracker, wasm, kubernetes-agent-sandbox, OWASP-ASI, agent-security, cve-2025-59528 | 7 | 6 | 8 | 9 | 5 | **6.95** | CANDIDATE | 2026-07-25 | 2026-07-25 |
